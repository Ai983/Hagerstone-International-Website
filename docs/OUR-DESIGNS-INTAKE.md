# /our-designs — how a deck becomes a page

Each design presentation becomes one page under `hagerstone.com/our-designs`. This file
...
```
Hagerstone Website Uploads/our-designs/
...
```bash
node scripts/our-designs-images.mjs --sheet --in <renders-dir> --out sheet.jpg
```
...
Copy an existing plan from `scripts/our-designs/` and edit it. Each image gets a
...
```bash
node scripts/our-designs-images.mjs --slug <slug> --in <renders-dir> \
  --plan scripts/our-designs/<slug>.redactions.json
```

It writes WebP at 1600 and 800 wide into `public/our-designs/<slug>/` and prints a
